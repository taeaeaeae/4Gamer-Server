...
class ChannelAdminService(
    ...
    @Transactional
    fun createBoard(channelId: Long, request: CreateBoardRequest): BoardResponse {
    ...
    @Transactional
    fun deleteBoard(channelId: Long, boardId: Long) {
        val board = channelAdminRepository.findByChannelIdAndId(channelId, boardId)
            ?: throw ModelNotFoundException("Channel", channelId)
    ...
    @Transactional
    fun doBlack(channelId: Long, memberId: UUID): ChannelBlackList {
